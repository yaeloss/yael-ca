---
title: "Technological literacy is doomed"
date: 2016-10-26
categories: 
  - "bitcoin"
  - "blog"
...
![image](images/tumblr_inline_ofnff1H5VT1qdn1ny_500.gif)
...
In those days, the beginning of each connection was ritualized by that [loud dial-up noise](https://www.youtube.com/watch?v=cmDo9Q93B0s), the pinging and bopping of infrastructure turning and burning somewhere off in the distance.
...
Oh sure, we’re _technological adopters,_ not we’re not necessarily _technological literates_. There’s a marked difference, and I’m seeing that more and more. 
...
I was confronted by this realization in the launching of a side project called the [CEVRO Café Club](http://cevrocafeclub.com) in Prague, Czech Republic. The idea was to offer access to a high-quality espresso machine to graduate students based on the idea of a monthly membership. In order to make it more special, we decided to require that all memberships be paid only in Bitcoin, the decentralized digital currency. 
...
The same is applied to TOR and the backbone of the “Darknet”. But one mustn’t be Ross Ulbrich or the U.S. federal government in order to be familiar with the Deep Web. It literally takes two seconds: [Download TOR](https://www.torproject.org/) and use it. Poke around. Fiddle. That’s what technology is all about.
