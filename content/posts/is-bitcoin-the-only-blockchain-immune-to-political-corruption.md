...
Though Bitcoin itself is a neutral protocol, many policymakers are, often rightfully so, skeptical of some cryptocurrency projects and of their connections to unsavory actors, whether it be [foreign adversaries](https://www.justice.gov/archives/opa/pr/three-north-korean-military-hackers-indicted-wide-ranging-scheme-commit-cyberattacks-and) or [unscrupulous insiders](https://www.justice.gov/usao-edny/pr/ceo-digital-asset-company-safemoon-sentenced-100-months-prison-multi-million-dollar). They rightfully worry about [illicit finance](https://www.wilsoncenter.org/publication/behind-headlines-debunking-misconceptions-cryptocurrency-and-crime), extortion rackets, and risks of kidnapping.

And when it comes to highly-speculative memecoins or the plethora of centrally controlled and managed cryptocurrencies [parading](https://www.justice.gov/usao-ma/pr/eighteen-individuals-and-entities-charged-international-operation-targeting-widespread) as serious projects (i.e. Terra LUNA), they’re not wrong. The incentive to inflate supply and pay insiders while retail traders deposit hard-earned money for a hope of a slice of the pie is very real.

The consequences of crypto corruption were on full display with FTX, where Sam Bankman-Fried’s [politically connected exchange](https://nymag.com/intelligencer/2021/02/sam-bankman-fried-biden-donor.html) funneled customer funds into political donations and risky bets, culminating in what prosecutors called “one of the biggest financial frauds in American history.”
...
The excesses of the broader crypto ecosystem require rules. Otherwise, [memecoins and rug pulls](https://www.btcpolicy.org/articles/how-smart-bitcoin-policies-can-save-us-from-memecoins-and-crypto-scams) will keep coming. From the Argentine president’s unfortunately-connected [pump-and-dump](https://www.reuters.com/world/americas/crypto-worth-99-million-withdrawn-milei-backed-libra-token-researchers-say-2025-02-20/) LIBRA token to the parade of celebrity-backed meme tokens designed to be extracted, the incentive structures of most crypto projects reward hype, insider access, and political proximity. Smart Bitcoin policy crafted in Washington should draw a clear line between these experiments and the neutral, open protocol that underpins Bitcoin.

What Americans need is legal clarity that protects[ the right to develop software](https://www.lummis.senate.gov/press-releases/lummis-wyden-introduce-bipartisan-legislation-to-protect-blockchain-developers-from-money-transmitter-requirements/), [self-custody digital assets](https://www.budd.senate.gov/2025/07/15/budd-lee-introduce-bill-to-protect-americans-right-to-control-their-digital-assets-and-secure-individual-financial-freedom/), and stops using the failures of politically connected crypto ventures to justify regulating away genuine innovation. That’s what framework bills like the CLARITY Act can achieve if drafted well.
...
‍*[Yaël Ossowski](https://www.btcpolicy.org/authors/yael-ossowski) is a fellow at the Bitcoin Policy Institute.*

*Published at BPI (archive [\#1](https://web.archive.org/web/www.btcpolicy.org/articles/is-bitcoin-the-only-blockchain-immune-to-political-corruption), #2).*
