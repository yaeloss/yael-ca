---
title: "Tobacco Monitoring First Step To Increased Sin Industry Scrutiny"
date: 2016-05-24
tags: 
  - "fctc"
  - "huffington-post"
...
She announced the [new monitoring centres](http://www.who.int/fctc/mediacentre/news/2016/brazilian-observatory-remarks-head-fctc/en/) in Rio de Janeiro to much pomp and circumstance at the end of March, foreshadowing the opening of dozens of more in the coming months and those that will focus on much more than just the tobacco industry.
...
"It will also serve as a model to monitor the actions of other industries, such as processed ​​food, alcoholic and soft drinks, considering that there are undeniable similarities between the strategies used by all these companies in order to undermine public policies," states the [observatory's website](http://www.ensp.fiocruz.br/portal-ensp/informe/site/materia/detalhe/39322).
...
Thus far, the monitoring centres aim to create "wiki" systems in order to track and disseminate the information gathered from their campaigns. An example was put together by the [Tobacco Control Research Group](http://www.bath.ac.uk/health/research/tobacco-control/) at the University of Bath, calling attention to the individuals and institutions "promoting a pro-tobacco agenda."

Such efforts are being funded in order to implement the WHO Framework Convention of Tobacco Control, implemented by the Conference of the Parties [held in Moscow in October 2014](http://www.who.int/mediacentre/news/releases/2014/cop6-tobacco-control/en/). It was made up of representatives from practically every country in the world, and remains closed only to participating parties and select governmental and non-governmental organizations.

The next Conference of the Parties is set to take place in [New Delhi India](http://www.who.int/fctc/news/2016/cop7tobehostedinindia/en/) in November 2016, where the next level of global tobacco regulation is due to be agreed upon.

The goal of the conference is to advance the "work of the WHO FCTC, thereby strengthening the global battle against the devastating consequences of tobacco use," [according to the website](http://www.who.int/fctc/news/2016/cop7tobehostedinindia/en/).
...
_Yaël Ossowski is a [Canadian journalist](http://yael.ca/) living in Vienna, Austria._

This was published in the [Huffington Post.](https://www.huffingtonpost.ca/yael-ossowski/tobacco-scrutiny_b_10060662.html)
